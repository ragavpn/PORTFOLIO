...
export function Frame10() {
  return (
    <div className="absolute bg-[#fca4bb] h-[490.812px] left-[1746.35px] overflow-clip rounded-[27.42px] top-[769.19px] w-[400.327px]">
...
export function Frame8() {
  return (
    <div className="absolute bg-[#f6f6f6] h-[490.812px] left-[1429.35px] overflow-clip rounded-[27.42px] top-[609.19px] w-[400.327px]">
      <Frame2 />
...
function Frame3() {
  return (
    <div className="absolute h-[363.311px] left-[71.29px] overflow-clip rounded-[27.42px] shadow-[4.113px_5.484px_6.444px_0px_rgba(0,0,0,0.25)] top-[71.29px] w-[257.745px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[410.583px] items-center justify-center left-[calc(50%+0.08px)] top-[calc(50%+9.46px)] w-[273.061px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "21" } as React.CSSProperties}>
...
export function Frame() {
  return (
    <div className="absolute bg-[#a96de7] h-[490.812px] left-[1106.35px] overflow-clip rounded-[27.42px] top-[439.19px] w-[400.327px]">
      <Frame3 />
...
export function Frame4() {
  return (
    <div className="absolute bg-[#f6f6f6] h-[490.812px] left-[786.35px] overflow-clip rounded-[27.42px] top-[289.19px] w-[400.327px]">
      <Frame5 />
      <Frame6 />
...
export function Frame7() {
  return (
    <div className="absolute bg-gradient-to-b from-[#6081b6] h-[490.812px] left-[465px] overflow-clip rounded-[27.42px] to-[#243969] top-[128px] w-[400.327px]">
      <Frame11 />
      <div className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold h-[128.872px] leading-[0] left-[24.68px] not-italic text-[56.21px] text-white top-[356.46px] tracking-[-4.4968px] w-[300.245px]">
        <p className="leading-[0.93] mb-0">Tranquility in</p>
        <p className="leading-[0.93]">wilderness.</p>
      </div>
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0.93] left-[318.07px] not-italic text-[26.049px] text-white top-[23.31px] tracking-[-2.0839px] whitespace-nowrap">2021</p>
    </div>
  );
}
...
export function Frame12() {
  return (
    <div className="absolute bg-[#ef8e35] h-[490.812px] left-[146px] overflow-clip rounded-[27.42px] top-[-34px] w-[400.327px]">
...
export function Frame15() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#b4e6eb] h-[490.812px] left-[calc(50%-933.84px)] overflow-clip rounded-[27.42px] top-[calc(50%-497.59px)] w-[400.327px]">
      <Frame16 />
...
export default function Paintings() {
  return (
    <div className="relative size-full" data-name="Paintings">
      <div className="absolute h-[1100px] left-0 top-0 w-[1920px]">
        <Frame10 />
        <Frame8 />
        <Frame />
        <Frame4 />
