...
export default function Paintings() {
  return (
    <div className="relative size-full" data-name="Paintings">
      <div className="absolute h-[1075px] left-0 top-0 w-[1920px]" data-name="Paintings">
        <div className="absolute flex h-[577.7px] items-center justify-center left-[729.3px] top-[243.56px] w-[513.718px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "64" } as React.CSSProperties}>
          <div className="-rotate-15 flex-none">
            <Frame10 />
          </div>
        </div>
        <div className="absolute flex h-[552.872px] items-center justify-center left-[746.43px] top-[255.97px] w-[479.474px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "64" } as React.CSSProperties}>
          <div className="-rotate-10 flex-none">
            <Frame8 />
          </div>
        </div>
        <div className="absolute flex h-[523.835px] items-center justify-center left-[765.72px] top-[273.68px] w-[441.581px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "64" } as React.CSSProperties}>
          <div className="-rotate-5 flex-none">
            <Frame />
          </div>
        </div>
        <Frame4 />
        <div className="absolute flex h-[523.835px] items-center justify-center left-[765.37px] top-[270.49px] w-[441.581px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "85" } as React.CSSProperties}>
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute flex h-[577.7px] items-center justify-center left-[calc(50%+26.16px)] top-[calc(50%-5.09px)] w-[513.718px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "64" } as React.CSSProperties}>
