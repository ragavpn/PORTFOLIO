# Portfolio 2026 - Ragav Palaniswamy

A high-performance, interactive portfolio built with **React**, **Vite**, **GSAP**, and **Framer Motion**. Designed with a premium aesthetic and smooth, physics-based interactions.
...
- **Frontend**: React (JS/TS), Vite
- **Animations**: GSAP (Draggable, ScrollTrigger), Framer Motion
- **Styling**: Tailwind CSS, Vanilla CSS
- **Media**: Custom SVG filters for grain/noise effects
